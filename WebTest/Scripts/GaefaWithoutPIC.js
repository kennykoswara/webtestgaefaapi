...
$(".addAdult").click(function () {
    $('.adultList').append('<div class="row appendedAdult"><div class="col-md-11"><input type="text" style="width: 100%; margin-top:1%" pattern="^[a-zA-Z]{3,}?([ ][a-zA-Z \.]{1,})?$" title="Minimum 3 letters for your first name. Only letters and space(s) are allowed" class="form-control" name="adult" placeholder="Adult Name" value="" required /></div><div class="col-md-1" style="padding-left:0%"><a href="javascript:void(0)"><i title="Click to remove this input box" class="fa fa-times-circle-o removeAdult"></i></a></div></div>');
    //boxCount += 1;
    passCount += 1;
    adultCount += 1;
    updateTotalPriceAndPeopleCount("adultCount", adultCount);
});

$(".addChild").click(function () {
    $('.childList').append('<div class="row appendedChild"><div class="col-md-11"><input type="text" style="width: 100%; margin-top:1%" pattern="^[a-zA-Z]{3,}?([ ][a-zA-Z \.]{1,})?$" title="Minimum 3 letters for your first name. Only letters and space(s) are allowed" class="form-control" name="child" placeholder="Child Name" value="" required /></div><div class="col-md-1" style="padding-left:0%"><a href="javascript:void(0)"><i title="Click to remove this input box" class="fa fa-times-circle-o removeChild"></i></a></div></div>');
    //boxCount += 1;
    passCount += 1;
    childCount += 1;
    updateTotalPriceAndPeopleCount("childCount", childCount);
});

$(".panel-body").on('click', '.removeAdult', function () {
    $(this).parents('.appendedAdult').remove();
    //boxCount += 1;
    passCount -= 1;
    adultCount -= 1;
    updateTotalPriceAndPeopleCount("adultCount", adultCount);
...
$(".panel-body").on('click', '.removeChild', function () {
    $(this).parents('.appendedChild').remove();
    //boxCount += 1;
    passCount -= 1;
    childCount -= 1;
    updateTotalPriceAndPeopleCount("childCount", childCount);
...
function updateTotalPriceAndPeopleCount(element, count) {
...
$(document).ready(function () {
    ...
    */
    ...
    for (i = 0; i < passCount; i++) {
        $('.adultList').append('<div class="row appendedAdult"><div class="col-md-11"><input type="text" style="width: 100%; margin-top:1%" pattern="^[a-zA-Z]{3,}?([ ][a-zA-Z \.]{1,})?$" title="Minimum 3 letters for your first name. Only letters and space(s) are allowed" class="form-control" name="adult" placeholder="Adult Name" value="" required /></div><div class="col-md-1" style="padding-left:0%"></div></div>');
    }
    */
